...
public class ExpressionsTestPart2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Expression ee3 = new Mult(new Pow(new Var("x"), new Num(2)), new Pow(new Var("x"), new Num(2))); // x^2 *
                                                                                                             // x^2
        ...
        try {
            ...
            e = new Mult(new Mult(new Var("x"), new Num(4)), new Mult(new Var("x"), new Num(20)));
        ...
        try {
            ...
            // differentiate by "y"
            // produces 0
            e = new Plus(new Mult(new Var("x"), new Num(100)), new Mult(new Var("x"), new Num(20)));
        ...
        try {
            ...
            e = new Div(new Pow(new Var("e"), new Mult(new Var("x"), new Num(3))), new Pow(new Var("e"), new Var("x")));
            assignment.clear();
